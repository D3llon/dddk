...
class BreedCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(Breed::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/breed');
        CRUD::setEntityNameStrings('Plemeno', 'Plemená');
    }
    ...
    {
        CRUD::setValidation(BreedRequest::class);

        CRUD::field('name')->label('Názov');
        CRUD::field('code')->label('Kód');
